...
public class ContentProvider implements Closeable {
    ...
    private Object getAttributionSource()
        ...
        if (attributionSource == null) {
            ...
            Object builder = cl.getConstructor(int.class).newInstance(FakeApp.USER_ID);
            cl.getDeclaredMethod("setPackageName", String.class).invoke(builder, FakeApp.PACKAGE_NAME);
        ...
        try {
            ...
            switch (callMethodVersion) {
                case 0:
                    ...
                    break;
                case 1:
                    args = new Object[]{FakeApp.PACKAGE_NAME, null, "settings", callMethod, arg, extras};
                    break;
                case 2:
                    args = new Object[]{FakeApp.PACKAGE_NAME, "settings", callMethod, arg, extras};
                    break;
                default:
                    args = new Object[]{FakeApp.PACKAGE_NAME, callMethod, arg, extras};
                    break;
            }
    ...
    public String getValue(String table, String key) throws SettingsException {
        ...
        arg.putInt(CALL_METHOD_USER_KEY, FakeApp.USER_ID);
        try {
